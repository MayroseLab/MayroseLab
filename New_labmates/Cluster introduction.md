...
```
srun --ntasks=56 -p power-general-public-pool -A power-general-users --pty bash
```

Or to use a specific machine:
```
srun --ntasks=56 -p power-general-public-pool -A power-general-users --nodelist="compute-0-12" --pty bash
```
